...
const Hero = () => {
  ...
  return (
    <section id="home" aria-label="Hero introduction" className="relative w-full min-h-screen overflow-hidden bg-[#050505]">
        ...
        <div className="flex flex-col items-start text-left max-w-2xl w-full relative z-30">
          ...
          >
            <div className="flex gap-4">
              <a href="https://github.com/Snehalkumar93" target="_blank" rel="noopener noreferrer" aria-label="GitHub profile" className="text-gray-400 hover:text-white transition-colors">
              ...
              <a href="https://linkedin.com/in/snehal-kumar93" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn profile" className="text-gray-400 hover:text-white transition-colors">
          ...
          >
            ...
            >
              <div className="w-full h-full rounded-full overflow-hidden border-4 border-black relative">
                <img 
                  src={heroImage} 
                  alt="Snehal Kumar - Full Stack Developer portrait"
                  loading="eager"
                  fetchPriority="high"
      ...
      >
        <div className="animate-bounce flex flex-col items-center gap-2">
          ...
          <svg className="w-5 h-5 text-gray-400" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
